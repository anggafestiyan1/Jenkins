...
/**
 * In-app player for a Stream video — either a local offline file path or a remote stream URL
 * (with optional request headers, e.g. Referer for some hosts). VideoView + MediaController.
 */
