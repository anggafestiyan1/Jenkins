...
import eu.kanade.presentation.library.components.AnimeContinueWatchingRow
...
fun AnimeLibraryContent(
    ...
    continueWatchingHistory: List<AnimeHistoryWithRelations>,
    onContinueWatchingHistoryClicked: (AnimeHistoryWithRelations) -> Unit,
) {
    Column(
        ...
        AnimeContinueWatchingRow(
            history = continueWatchingHistory,
            onClickItem = onContinueWatchingHistoryClicked,
        )
