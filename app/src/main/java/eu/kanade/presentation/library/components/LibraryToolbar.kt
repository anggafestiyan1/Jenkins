...
private fun LibraryRegularToolbar(
    ...
    SearchToolbar(
        ...
        actions = {
            ...
            val activeTint = MaterialTheme.colorScheme.active
            ...
            AppBarActions(
                persistentListOf(
                    AppBar.Action(
                        ...
                        iconTint = if (downloadedOnly) activeTint else defaultTint,
                        onClick = onToggleDownloadedOnly,
                    ),
                    AppBar.Action(
                        title = stringResource(MR.strings.pref_incognito_mode),
                        icon = ImageVector.vectorResource(R.drawable.ic_glasses_24dp),
                        iconTint = if (incognitoMode) activeTint else defaultTint,
