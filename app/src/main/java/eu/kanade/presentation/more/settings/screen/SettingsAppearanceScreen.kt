...
import eu.kanade.domain.ui.model.HideLibraryTab
    ...
    private fun getDisplayGroup(
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = persistentListOf(
                ...
                Preference.PreferenceItem.ListPreference(
                    preference = uiPreferences.hideLibraryTab(),
                    entries = HideLibraryTab.entries
                        .associateWith { stringResource(it.titleRes) }
                        .toImmutableMap(),
                    title = stringResource(AYMR.strings.pref_hide_library_tab),
                    onValueChanged = {
                        context.toast(MR.strings.requires_app_restart)
                        true
                    },
                ...
                Preference.PreferenceItem.SwitchPreference(
                    preference = uiPreferences.showContinueReadingCard(),
                    title = stringResource(AYMR.strings.pref_show_continue_reading_card),
                ),
                Preference.PreferenceItem.ListPreference(
